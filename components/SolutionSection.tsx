        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-3/5 order-1 md:order-2">
            ...
            <div className="mt-10">
              <a 
                href="#pillars"
                className="inline-flex items-center text-gold font-bold hover:text-white transition-colors group"
              >
                <span className="uppercase tracking-widest text-sm">Descubra o que está dentro do livro</span>
                <svg className="w-5 h-5 ml-2 group-hover:translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
              </a>
            </div>
          </div>
        </div>
